...
(* OASIS_START *)
(* DO NOT EDIT (digest: a202289a506b24f9c05badf006eed36a) *)
(*
...
let setup_t =
  {
       ...
       [
          ...
          ("persistence_test",
            CustomPlugin.Test.main
              {
                 CustomPlugin.cmd_main =
                   [(OASISExpr.EBool true, ("$persistence_test", []))];
                 cmd_clean = [(OASISExpr.EBool true, None)];
                 cmd_distclean = [(OASISExpr.EBool true, None)]
              })
       ];
            ...
            [
               ...
               Executable
                 ({
                   ...
                   {exec_custom = true; exec_main_is = "persistence_test.ml"});
               Executable
                 ({
     ...
     oasis_version = "0.4.4";
     oasis_digest = Some "X@{>\253\192\135\218\212\173\232\003~\005\201\232";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
