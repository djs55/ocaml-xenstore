...
(* OASIS_START *)
(* DO NOT EDIT (digest: fd9b68bc4cbf0c572abc8792c23a749c) *)
(*
...
let setup_t =
  {
            ...
            [
               Flag
                 ({
                   ...
                   {
                      flag_description = Some "build shared-memory interface";
                 ...
                 ({
                  ...
                  },
                   {
                      bs_build =
                        [
                           (OASISExpr.EBool true, false);
                           (OASISExpr.EFlag "kernelspace", true)
                        ];
                      bs_install = [(OASISExpr.EBool true, true)];
                      bs_path = "kernelspace";
                      bs_compiled_object = Best;
     ...
     oasis_version = "0.4.4";
     oasis_digest = Some "S¿À9\142äì®46Rè¼\030l5";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
